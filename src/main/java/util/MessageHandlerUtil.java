    ...
    private static String handleTextMessage(Map<String, String> map) {
        ...
        switch (content) {
            ...
            case "图片":
                ...
                String imgMediaId = "TqZVQHk_FOKxuqFnnJrnf67aKWpsgbknKq1te1DmFyigPU-pczzzKnLRYHKGlT8T";
                responseMessage = buildImageMessage(map, imgMediaId);
                break;
            case "语音":
                //通过素材管理接口上传语音文件时得到的media_id
                String voiceMediaId = "RsODkuNPy5-lV94k_zaIzIRw320S0UG9oT3joRqRLs-Wh-grn_61LPF0EPDRXqc1";
            ...
            case "音乐":
                ...
                music.musicUrl = "http://ff6249e125ce.ngrok.io/wxHandler/media/music/music.mp3";
                music.hqMusicUrl = "http://ff6249e125ce.ngrok.io/wxHandler//media/music/music.mp3";
                responseMessage = buildMusicMessage(map, music);
                break;
            case "视频":
                Video video = new Video();
                video.mediaId = "7qHs9XaIF_OUc-ocoFeoLQAOvUkJSA-iXQaW8_ZGXYgsDLVvIoySzYFqWjH9aOaa";
                video.title = "小苹果";
